...
public class Response extends FertileNode {
    public Response(){
        super("Response");
    }
    /**
     ...
     * @return the node
     */
    public Response appendChild(Node child){
        if(this == child){
     ...
     * @return the node
     */
    public Response appendChild(int index, Node child){
        if(this == child){
            throw new Error("Cannot append a node to itself.");
        }
        child.setParent(this);
     ...
     * @return the node
     */
    public Response appendChild(List<Node> children){
        if(children != null){;
     ...
     * @return the node
     */
    public Response appendChild(Node... children){
     ...
     * @return the node
     */
    public Response appendText(String text){
